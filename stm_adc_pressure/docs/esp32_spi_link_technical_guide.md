...
- ESP32 检测到 `ESP_LINK_RDY=1` 后，发起一次完整 SPI 事务，长度固定为 `3112 bytes`。
...
| `16` | `4` | `sample_rate_hz` | 当前固定 `51470` |
...
- ESP32 端平均处理速度必须高于 `201 包/秒`
- 如果连续超过约 `20 ms` 未能取走数据，STM32 侧就可能开始丢包
...
[LINK] pkt=3112B payload=3072B 51470Hz/ch
